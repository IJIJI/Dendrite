...
Try it: `cd playground && yarn && yarn dev` — a fully client-side [playground](playground/README.md) with live evaluation, descriptor-driven inputs, and inline diagnostics.
