...
Changes to `@dendrite-lang/core`, newest first. Each version's release date is on its
[GitHub release](https://github.com/IJIJI/Dendrite/releases), tagged `@dendrite-lang/core@<version>`.
